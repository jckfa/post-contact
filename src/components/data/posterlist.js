const posterList = [
...

  {
    ...
    authors: [
      {
        name: 'Casey Bennett',
        url: 'https://www.caseybennett.net/'
      },

      {
        name: 'Kate Schneider',
        url: 'http://kateschneider.net/'
      },
    ],
...

  {
    ...
    authors: [
      {
        name: 'Utkan Dora Öncül',
        url: 'https://utkandora.com/',
      }
    ],
    size: '30"W×40"H',
...

  {
    ...
    authors: [
      {
        name: 'Carmen Ribaudo',
        url: 'http://www.carmen-ribaudo.com/',
      }
    ],
...

  {
    ...
    authors: [
      {
        name: 'Huy Vu',
        url: 'https://www.instagram.com/huy.vu/',
      }
    ],
    size: '30"W×40"H',
...

  {
    ...
    note: `Using <a href="https://sharptype.co/typefaces/Doyle/" target='_blank' rel='noopener noreferrer'>Doyle</a> courteous of <a href="https://sharptype.co/" target='_blank' rel='noopener noreferrer'>Sharp Type</a>. Printed on paper generously donated by <a href='https://www.centralpaperonline.com/'  target='_blank' rel='noopener noreferrer'>Central Paper Co.</a> in Pawtucket, RI.`
  },
...

  {
    ...
    authors: [
      {
        name: 'Eliza Chen',
        url: 'https://www.instagram.com/tongue_and_liver/',
      }
    ],
...

  {
    ...
    authors: [
      {
        name: 'Greta Huang Skagerlind',
        url: 'http://gskagerlind.com/',
      }
    ],
    size: '30"W×40"H',
...

  {
    ...
    authors: [
      {
        name: 'Samuli & Johanna Lindberg',
        url: 'http://www.samulilindberg.fi/',
      }
    ],
    size: '30"W×40"H',
...

  {
    ...
    authors: [
      {
        name: 'Urgency Reader 2',
        url: 'https://queer.archive.work/urgencyreader2/',
      }
    ],
    size: '30"W×40"H',
